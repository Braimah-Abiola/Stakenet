      ...
      <div className="flex flex-col items-center -mt-20 md:-mt-0 mb-40">
        ...
        >
          ...
          <AccordionItem value="item-5">
            ...
            <AccordionContent>
              Joining the Stakenet community is simple! Sign up for our waitlist
              and join the telegram channel to gain early access to the platform
              and become part of a vibrant community of like-minded individuals
              passionate about online betting.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </div>
