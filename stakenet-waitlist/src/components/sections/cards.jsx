  ...
  return (
    <div className="w-full flex flex-row items-center justify-center px-40">
      ...
      <div className="flex flex-col -mr-60 -space-y-20">
        ...
        <div className="w-[400px] h-[200px] relative -rotate-12 z-1" ref={(el) => (imageRefs.current[2] = el)}>
      ...
      <div className="flex flex-col -ml-60 -space-y-20">
        ...
        <div className="w-[400px] h-[200px] rotate-12 relative" ref={(el) => (imageRefs.current[5] = el)}>
