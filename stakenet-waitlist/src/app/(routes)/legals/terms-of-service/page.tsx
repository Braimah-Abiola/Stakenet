  ...
  return (
    <div className="w-full px-40 flex flex-col items-center">
      ...
      <div className=" max-w-xl gap-6 mt-5 flex flex-col">
        ...
        <h4 className=" text-white/80 text-lg">
          By accessing stakenet.co, you agree to abide by these Terms of Service
        ...
        <div className="flex flex-row items-start gap-2.5">
          ...
          <h4 className=" text-white/80 text-lg -mt-2 text-start">
        ...
        <div className="flex flex-row items-start gap-2.5">
          ...
          <h4 className=" text-white/80 text-lg -mt-2 text-start">
            ...
            otherservice Stakenet provides;
          </h4>
        </div>
        <div className="flex flex-row items-start gap-2.5">
          <div className="h-2.5 w-2.5 aspect-square bg-white rounded-full" />
        ...
        <h4 className=" text-white/80 text-lg">
          ...
          are owned by or licensed to Stakenet and are protected by applicable
        ...
        <h4 className=" text-white/80 text-lg">
          ...
          &apos;as is&apos; basis. To the extent permitted by law, Stakenet
          makes no warranties, expressed or implied, and hereby disclaims and
          negates all other warranties including, without limitation, implied
          warranties or conditions of merchantability, or non-infringement of
          intellectual property, or other violation of rights.
        </h4>
        <h4 className=" text-white/80 text-lg">
          In no event shall Stakenet or our suppliers be liable for any
          ...
          on this website, even if we or an authorized representative has been
        ...
        <h4 className=" text-white/80 text-lg">
          ...
          for general information purposes only. We do not warrant or make any
        ...
        <h4 className=" text-white/80 text-lg">
          Stakenet has not reviewed all of the sites linked to its website and
          is not responsible for the contents of any such linked site. The
          inclusion of any link does not imply endorsement, approval, or control
          by Stakenet of the site. Use of any such linked site is at your own
        ...
        <h4 className=" text-white/80 text-lg">
          Stakenet may suspend or terminate your right to use our website and
